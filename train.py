...
def collate_records(records, gen_records, opts):
    ...
    for record_path in records:
        ...
        try:
            accl_x = float(json_data['imu/acc_x'])
            accl_y = float(json_data['imu/acc_y'])
            accl_z = float(json_data['imu/acc_z'])

            gyro_x = float(json_data['imu/gyro_x'])
            gyro_y = float(json_data['imu/gyro_y'])
